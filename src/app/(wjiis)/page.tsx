...
export default function HomePage() {
  ...
  return (
    <>
      <DynamicSEO
        title="EJOAS - European Journal of Agricultural Sciences"
        description="Publishing rigorous, peer-reviewed research in agricultural sciences for a global audience."
        keywords={['agricultural sciences', 'agricultural research', 'research journal', 'academic publishing', 'EJOAS', 'peer review']}
        ogImage="https://ejoas.com/og-image.jpg"
        canonicalUrl="https://ejoas.com"
      />
      <WebsiteSchema
        name="EJOAS"
        url="https://ejoas.com"
      ...
      <OrganizationSchema
        name="EJOAS"
        url="https://ejoas.com"
        logo="https://ejoas.com/ejoas-logo.svg"
        description="EJOAS - European Journal of Agricultural Sciences"
        contactPoint={{
          email: "editor@ejoas.com",
      ...
      <div className="min-h-screen font-sans">
        ...
        {/* Hero Section */}
        <section className="relative border-b border-slate-200" style={{background: 'linear-gradient(135deg, #1a4d3a 0%, #2d6b52 100%)'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-8 space-y-6">
                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold tracking-wide uppercase" style={{background: 'rgba(255,255,255,0.15)', color: '#a8d5ba'}}>
                  ISSN: 2959-XXXX (Online)
                </div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-white">
                  ...
                  <span style={{color: '#c4a747'}}>Agricultural Research Excellence</span>
                </h1>

                <p className="text-xl max-w-2xl leading-relaxed" style={{color: '#a8d5ba'}}>
                  A peer-reviewed, open-access journal dedicated to publishing cutting-edge research across all domains of agricultural sciences.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link
                    ...
                    onMouseEnter={e => (e.currentTarget.style.background='#a88937')}
                    onMouseLeave={e => (e.currentTarget.style.background='#c4a747')}
                  >
                    Submit Manuscript
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 max-w-lg" style={{borderTop: '1px solid rgba(255,255,255,0.2)'}}>
                  <div>
                    ...
                    <div className="text-sm font-medium" style={{color: '#a8d5ba'}}>Published Papers</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">{stats.totalAuthors.toLocaleString()}+</div>
                    <div className="text-sm font-medium" style={{color: '#a8d5ba'}}>Authors</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">12+</div>
                    <div className="text-sm font-medium" style={{color: '#a8d5ba'}}>Indexing</div>
                  </div>
                </div>
              </div>
            ...
            {loading ? (
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {latestPapers.map((paper) => (
                  <div key={paper.id} className="group bg-white rounded-lg p-6 border border-slate-200 hover:shadow-md transition-all duration-200" style={{borderTop: '3px solid #2d6b52'}}>
                    <div className="flex items-start justify-between mb-3">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium" style={{background: '#e8f5f0', color: '#2d6b52'}}>
                        {paper.category}
                      </span>
                    ...
                    <h3 className="font-serif font-bold text-lg mb-2 transition-colors line-clamp-2" style={{color: '#1a4d3a'}}>
                    ...
                    <div className="mb-4 text-xs text-slate-500">
                      <span className="font-semibold" style={{color: '#2d6b52'}}>Authors:</span> {paper.authors.join(', ')}
                    </div>
        ...
        {/* Why Choose Us */}
        <section className="py-16 border-y border-slate-200" style={{background: '#f0faf6'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-serif font-bold mb-4" style={{color: '#1a4d3a'}}>Journal Features</h2>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div key={index} className="bg-white rounded-lg p-6 shadow-sm" style={{border: '1px solid #a8d5ba', borderTop: '3px solid #c4a747'}}>
                  <feature.icon className="w-8 h-8 mb-4" style={{color: '#2d6b52'}} />
                  <h3 className="text-lg font-bold mb-2" style={{color: '#1a4d3a'}}>{feature.title}</h3>
        ...
        {/* CTA */}
        <section className="py-16 text-white" style={{background: 'linear-gradient(135deg, #1a4d3a 0%, #2d6b52 100%)'}}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 text-white">
              Submit Your Research Today
            </h2>
            <p className="mb-8 text-lg" style={{color: '#a8d5ba'}}>
